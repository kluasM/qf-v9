    ...
    <div class="scoll">
        <section class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="${product.image}" title="pic" />
                    </li>
                    <li>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="images/01.jpg"><img src="${product.image}" alt="细节展示放大镜特效" rel="images/01.jpg" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${product.image}" mid="images/01_mid.jpg" big="images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${product.image}" mid="images/02_mid.jpg" big="images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${product.image}" mid="images/03_mid.jpg" big="images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${product.salePrice}</b>  </dd>
                    </li>
